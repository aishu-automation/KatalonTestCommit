...
for (int i = 1; i <= totalBars; i++) {
	...
	WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetentionRisk/RI_RetentionRiskEmployee(Long_Term)UserCountExcelPage/Page_ProHance AI - Retention Risk/span_10'))
	
	WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetentionRisk/RI_RetentionRiskEmployee(Long_Term)UserCountExcelPage/Page_ProHance AI - Retention Risk/div_100'))
	
	WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetentionRisk/RI_RetentionRiskEmployee(Long_Term)UserCountExcelPage/Page_ProHance AI - Retention Risk/span_Username'))
...
"""
	...
	WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetentionRisk/RI_RetentionRiskEmployee(Long_Term)UserCountExcelPage/Page_ProHance AI - Retention Risk/path'))
	WebUI.delay(4)
