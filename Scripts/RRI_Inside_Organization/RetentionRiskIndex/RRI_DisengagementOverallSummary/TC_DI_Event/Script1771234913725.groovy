...
WebUI.rightClick(findTestObject('Object Repository/RRI_Inside_Organization/DisEngagement/DI_OverallSummaryAddEventPage/Page_ProHance AI - Retention Risk/div_2312 - 2912'))
...
WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/DisEngagement/DI_OverallSummaryAddEventPage/Page_ProHance AI - Retention Risk/svg'))

WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/DisEngagement/DI_OverallSummaryAddEventPage/Page_ProHance AI - Retention Risk/input_Event Name_ant-input css-dev-only-do-_f2d6e3'))

WebUI.setText(findTestObject('Object Repository/RRI_Inside_Organization/DisEngagement/DI_OverallSummaryAddEventPage/Page_ProHance AI - Retention Risk/input_Event Name_ant-input css-dev-only-do-_f2d6e3_3'), 
    'add')

WebUI.setText(findTestObject('Object Repository/RRI_Inside_Organization/DisEngagement/DI_OverallSummaryAddEventPage/Page_ProHance AI - Retention Risk/textarea_asdd'), 'asdd')

WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/DisEngagement/DI_OverallSummaryAddEventPage/Page_ProHance AI - Retention Risk/button_Save'))

WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/DisEngagement/DI_OverallSummaryAddEventPage/Page_ProHance AI - Retention Risk/div_Event added successfully'))
