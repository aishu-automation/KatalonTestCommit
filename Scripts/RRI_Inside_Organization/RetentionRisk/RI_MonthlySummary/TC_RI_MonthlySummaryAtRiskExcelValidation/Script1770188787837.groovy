...
high.addProperty('xpath', ConditionType.EQUALS, '(//*[@class=\'apexcharts-series-markers\']/../*[1]//*[name()=\'path\'])[3]')

WebUI.waitForElementClickable(high, 20)
WebUI.click(high)

WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetentionRisk/RI_MonthlySummaryAtRiskExcelPage/Page_ProHance AI - Retention Risk/span_10'))

WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetentionRisk/RI_MonthlySummaryAtRiskExcelPage/Page_ProHance AI - Retention Risk/div_100'))

WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetentionRisk/RI_MonthlySummaryAtRiskExcelPage/Page_ProHance AI - Retention Risk/span_Username'))
...
WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetentionRisk/RI_MonthlySummaryAtRiskExcelPage/Page_ProHance AI - Retention Risk/svg'))
