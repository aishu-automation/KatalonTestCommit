...
WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetentionRisk/RI_OverallSummaryDefaultExcelPage/Page_ProHance AI - Retention Risk/svg_Retention Risk_MuiSvgIcon-root MuiSvgIc_47fccd'))

WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetentionRisk/RI_OverallSummaryDefaultExcelPage/Page_ProHance AI - Retention Risk/span_10'))

WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetentionRisk/RI_OverallSummaryDefaultExcelPage/Page_ProHance AI - Retention Risk/div_100'))

WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetentionRisk/RI_OverallSummaryDefaultExcelPage/Page_ProHance AI - Retention Risk/span_Username'))
...
"""
	...
	if (fill.contains('e74c3c') || fill.contains('rgb(231,76,60)')) return 'At Risk'
	//if (fill.contains('f1c40f') || fill.contains('rgb(241,196,15)')) return 'Medium'
	if (fill.contains('27ae60') || fill.contains('rgb(39,174,96)')) return 'No Risk'
...
WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetentionRisk/RI_OverallSummaryDefaultExcelPage/Page_ProHance AI - Retention Risk/button_Computed forDec - 2024_ant-btn css-o_3cdcd5'))
WebUI.delay(4)
...
// Get the latest downloaded file (already handles waiting, size stabilization, etc.)
File sourceFile = CustomKeywords.'utility.ExcelUtil.getMostRecentFile'(downloadPath, ".xlsx")
println "✅ Downloaded file: ${sourceFile.name}"

// Prepare working and clean copies
File workingFile = new File(downloadPath + File.separator + "working_" + sourceFile.name)
File cleanFile   = new File(downloadPath + File.separator + "clean_" + sourceFile.name)
