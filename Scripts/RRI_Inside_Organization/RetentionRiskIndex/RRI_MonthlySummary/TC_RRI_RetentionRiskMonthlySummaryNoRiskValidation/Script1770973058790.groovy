...
high.addProperty('xpath', ConditionType.EQUALS, '((//*[name()=\'g\' and @class="apexcharts-series-markers-wrap apexcharts-hidden-element-shown"])[4]//*[name()=\'g\' and @class="apexcharts-series-markers"])[1]//*[name()=\'path\']')
...
WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetebtionRiskIndex/RetentionRiskMonthlySummaryNoRiskPage/Page_ProHance AI - Retention Risk/span_Username'))

WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetebtionRiskIndex/RetentionRiskMonthlySummaryNoRiskPage/Page_ProHance AI - Retention Risk/span_Employee ID'))

WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetebtionRiskIndex/RetentionRiskMonthlySummaryNoRiskPage/Page_ProHance AI - Retention Risk/span_User Group'))

WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetebtionRiskIndex/RetentionRiskMonthlySummaryNoRiskPage/Page_ProHance AI - Retention Risk/th_Disengagement (12 W)'))

WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetebtionRiskIndex/RetentionRiskMonthlySummaryNoRiskPage/Page_ProHance AI - Retention Risk/th_Retention Risk (12 M)'))

WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetebtionRiskIndex/RetentionRiskMonthlySummaryNoRiskPage/Page_ProHance AI - Retention Risk/div_Total Records 100Displaying 1 to 10'))
