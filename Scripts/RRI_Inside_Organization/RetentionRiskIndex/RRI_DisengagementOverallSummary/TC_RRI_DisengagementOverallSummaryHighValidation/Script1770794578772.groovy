...
WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetebtionRiskIndex/DisengagementOverallSummaryHighDrilldownPage/Page_ProHance AI - Retention Risk/span_Username'))

WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetebtionRiskIndex/DisengagementOverallSummaryHighDrilldownPage/Page_ProHance AI - Retention Risk/span_Employee ID'))

WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetebtionRiskIndex/DisengagementOverallSummaryHighDrilldownPage/Page_ProHance AI - Retention Risk/span_User Group'))

WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetebtionRiskIndex/DisengagementOverallSummaryHighDrilldownPage/Page_ProHance AI - Retention Risk/th_Disengagement (12 W)'))

WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetebtionRiskIndex/DisengagementOverallSummaryHighDrilldownPage/Page_ProHance AI - Retention Risk/div_Retention Risk'))

WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetebtionRiskIndex/DisengagementOverallSummaryHighDrilldownPage/Page_ProHance AI - Retention Risk/div_Total Records 44Displaying 1 to 10'))
...
WebUI.verifyMatch(totalRecordsStr, high, false)
WebUI.closeBrowser()
