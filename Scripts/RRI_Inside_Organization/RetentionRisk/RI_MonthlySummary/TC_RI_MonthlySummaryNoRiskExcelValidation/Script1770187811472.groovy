...
WebUI.click(high)
WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetentionRisk/RI_MonthlySummaryNoRiskExcelPage/Page_ProHance AI - Retention Risk/span_10'))

WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetentionRisk/RI_MonthlySummaryNoRiskExcelPage/Page_ProHance AI - Retention Risk/div_100'))

WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetentionRisk/RI_MonthlySummaryNoRiskExcelPage/Page_ProHance AI - Retention Risk/span_Username'))
...
WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetentionRisk/RI_MonthlySummaryNoRiskExcelPage/Page_ProHance AI - Retention Risk/span_Computed forDec - 2024_ant-btn-icon'))
