...
highText.addProperty('xpath', ConditionType.EQUALS, '(//*[name()=\'g\' and @class="apexcharts-heatmap"]//*[name()=\'g\' and @class="apexcharts-data-labels"])[4]')
...
fourthRect.addProperty(
	...
	"(//*[name()='rect' and contains(@class,'apexcharts-heatmap-rect')])[4]"
)
// Wait for it
...
WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetebtionRiskIndex/DIvsRIDisengagementMediumAndHighWithRetentionNoRiskPage/Page_ProHance AI - Retention Risk/span_Username'))

WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetebtionRiskIndex/DIvsRIDisengagementMediumAndHighWithRetentionNoRiskPage/Page_ProHance AI - Retention Risk/span_Employee ID'))

WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetebtionRiskIndex/DIvsRIDisengagementMediumAndHighWithRetentionNoRiskPage/Page_ProHance AI - Retention Risk/span_User Group'))

WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetebtionRiskIndex/DIvsRIDisengagementMediumAndHighWithRetentionNoRiskPage/Page_ProHance AI - Retention Risk/span_Disengagement'))

WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetebtionRiskIndex/DIvsRIDisengagementMediumAndHighWithRetentionNoRiskPage/Page_ProHance AI - Retention Risk/span_Retention Risk'))
