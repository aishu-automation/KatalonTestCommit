...
fourthRect.addProperty(
	...
	"(//*[name()='rect' and contains(@class,'apexcharts-heatmap-rect')])[2]"
)
// Wait for it
...
WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetebtionRiskIndex/DIvsRIDisengagementMediumAndHighWithRetentionAtRiskPage/Page_ProHance AI - Retention Risk/span_Username'))

WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetebtionRiskIndex/DIvsRIDisengagementMediumAndHighWithRetentionAtRiskPage/Page_ProHance AI - Retention Risk/span_Employee ID'))

WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetebtionRiskIndex/DIvsRIDisengagementMediumAndHighWithRetentionAtRiskPage/Page_ProHance AI - Retention Risk/span_User Group'))

WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetebtionRiskIndex/DIvsRIDisengagementMediumAndHighWithRetentionAtRiskPage/Page_ProHance AI - Retention Risk/span_Disengagement'))

WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetebtionRiskIndex/DIvsRIDisengagementMediumAndHighWithRetentionAtRiskPage/Page_ProHance AI - Retention Risk/div_Retention Risk'))

WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetebtionRiskIndex/DIvsRIDisengagementMediumAndHighWithRetentionAtRiskPage/Page_ProHance AI - Retention Risk/div_Total Records 3Displaying 1 to 3'))
