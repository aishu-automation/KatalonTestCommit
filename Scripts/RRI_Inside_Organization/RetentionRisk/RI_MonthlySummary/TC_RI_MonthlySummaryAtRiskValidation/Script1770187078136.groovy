...
def matcher = mainTooltip =~ /At Risk:\s*(\d+)\s*\(\s*([\d.]+%)\s*\)/
String value = "0"
if (matcher.find()) {
...
def expectedCheckboxState = [('No Risk') : false, ('At Risk') :true ]
...
WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/RetentionRisk/RI_MonthlySummaryAtRiskPage/Page_ProHance AI - Retention Risk/div_Total Records 6Displaying 1 to 6'))
