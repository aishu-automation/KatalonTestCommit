...
WebUI.click(bar)
WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/DisEngagement/DI_barChart_BreakupOverallDrilldownByAttributeAndUserCountExcelPage/Page_ProHance AI - Retention Risk/span_10'))

WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/DisEngagement/DI_barChart_BreakupOverallDrilldownByAttributeAndUserCountExcelPage/Page_ProHance AI - Retention Risk/div_100'))

WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/DisEngagement/DI_barChart_BreakupOverallDrilldownByAttributeAndUserCountExcelPage/Page_ProHance AI - Retention Risk/span_Username'))
WebDriver driver = DriverFactory.getWebDriver()
	...
	// ================= DOWNLOAD EXCEL =================
	WebUI.click(findTestObject('Object Repository/RRI_Inside_Organization/DisEngagement/DI_barChart_BreakupOverallDrilldownByAttributeAndUserCountExcelPage/Page_ProHance AI - Retention Risk/svg'))
