...
} else if ((statusText == 'DI') || (statusText == 'DI and RI')) {
	WebUI.callTestCase(findTestCase('RRI_Inside_Organization/RetentionRisk/RI_EnableRIModule'), [:], FailureHandling.STOP_ON_FAILURE)
} else {
